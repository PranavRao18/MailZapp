  ...
  return (
    <div className="bg-black text-white min-h-screen p-8">
      <header className="text-center py-8">
        <h1 className="text-5xl font-bold mb-4">About MailZapp</h1>
      ...
      <main className="max-w-5xl mx-auto">
        ...
        <section className="mb-16" data-aos="fade-up" data-aos-delay="400">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <FeatureCard
              ...
              icon={<FaDollarSign size={50} className="text-green-500" />}
            />
            <FeatureCard
              title="Real-Time Insights"
              description="Analyze and optimize your campaigns effortlessly."
              icon={<FaChartLine size={50} className="text-blue-500" />}
            />
          </div>
        </section>
        ...
        <section className="mb-16" data-aos="fade-up" data-aos-delay="800">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <FeatureCard
              ...
              icon={<FaHandsHelping size={50} className="text-orange-500" />}
            />
            <FeatureCard
              title="Excellence"
              description="Delivering top-notch quality in every feature and service."
              icon={<FaChartLine size={50} className="text-teal-500" />}
            />
          </div>
        </section>
        ...
        <section className="mb-16" data-aos="fade-up" data-aos-delay="1000">
          ...
          <p className="text-lg text-gray-300">
            MailZapp’s team consists of passionate developers, designers
            dedicated to empowering businesses. We believe in
